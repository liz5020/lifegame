...
for (const f of ["worker/worker.js", "worker/prompt.js", "worker/ap.js", "worker/usage.js"]) execFileSync("node", ["--check", ROOT + "/" + f]);
console.log("語法檢查：通過（index.html <script>、worker/*.js）");
